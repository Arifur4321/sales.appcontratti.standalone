...
Route::get('/signature/view/{id}', [App\Http\Controllers\SignatureController::class, 'logView'])->name('signature.view');

Route::post('/track-viewed/{id}', [App\Http\Controllers\SignatureController::class, 'trackViewed'])->name('track.viewed');
...
Route::get('/sign-document/{id}', [App\Http\Controllers\SignatureController::class, 'viewSignedDocument'])->name('sign.document.view');
...
Route::post('/resend-otp', [App\Http\Controllers\OTPController::class, 'sendOTP'])->name('resend.otp');
...
// web.php (Route file)
Route::get('/check-sms-enabled', [App\Http\Controllers\OTPController::class, 'checkSMSEnabled'])->name('check.sms.enabled');
...
Route::get('/get-contract-variable-status/{id}', [App\Http\Controllers\ProductController::class, 'getContractVariableStatus']);
...
Route::get('/serve-pdf/{filename}', [App\Http\Controllers\ProductController::class, 'servePdf']);

Route::get('/serve-pdf/{filename}', [App\Http\Controllers\ProductController::class, 'servePdf'])->name('serve.pdf');
...
Route::get('/signature/get-company-name/{id}', [App\Http\Controllers\SignatureController::class, 'getCompanyName']);
...
Route::get('/contract/{id}/mobile-number', [App\Http\Controllers\OTPController::class, 'getMobileNumber']);

Route::post('/change-language', [App\Http\Controllers\LocalizationController::class, 'changeLanguage'])->name('change.language');

//Route::get('/test-update-pdfs', function () {
//    $controller = new \App\Http\Controllers\SignatureController();  
//    return $controller->updateMissingPdfContent(419, 1000);    
//});
